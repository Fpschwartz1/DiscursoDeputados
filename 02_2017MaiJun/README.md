...
Lê os arquivos "discurso_AAAA_dit.csv", decodifica cada discurso para **rtf**, utiliza a função **retira_fig** passando os demarcadores de início e fim e grava no arquivo "Discursos_AAAA.txt" um texto único (*corpus*) com todos os discursos do respecitvo ano.

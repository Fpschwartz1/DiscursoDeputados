...
p1 <- tfq[1:20,] %>%
   ...
   ylab("Freq") + xlab("Palavra") + ggtitle("Frequência Absoluta")
...
plot(hc, labels = tfq$WORD, main = "Frequência absoluta", xlab = "Palavras")
...
p3 <- bigramas %>%
   ...
   coord_flip() +
   theme(panel.background = element_rect(fill='white', colour='gray')) +
   ylab("Freq") + xlab("Bigrama") + ggtitle("Frequência absoluta")
p3
```
...
plot(hc, labels = bigramas$bigram, main = "Frequência absoluta", xlab = "Bigramas")
